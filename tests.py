...
class TestAggregatePayment(IsolatedAsyncioTestCase):
    """Tests main function in general"""
    test_data = [
        [
            {
                # input_1
    ...
    async def test_basic(self):
        ...
        for input_, output_ in self.test_data:
            assert str(output_) == await aggregate_payments(json.dumps(input_))
